        ...
        <div class="user-form-wrap">
            <div class="user-form-wraps">
                ...
                <form data-form="userlogin" action="login.do" method="post">
                    ...
                    <div class="user-form-item">
                        <input class="user-input user-input-adjust" name="vcode" type="text" max="4" placeholder="验证码"><img class="qrcode" src="vcode.do" id="prove" title="换一张" alt="加载中" onclick="changeCode(this)" style="cursor:pointer;"></div>
                    <div class="user-form-item">
                        <label>
          ...
          <span class="cos_span">
            <a href="http://www.119hqw.com/user/usResetPwd.php">忘记密码?</a></span>&nbsp;&nbsp;
                    <span class="cos_span_empty">
            <a href="http://www.119hqw.com/user/usRegister.php">注册账号</a></span>
                </div>
            </div>
        </div>
    </div>
