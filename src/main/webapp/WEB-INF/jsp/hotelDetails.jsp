    ...
    <div class="layout_center">
            ...
            <div class="shops-deta layout_clear layout_fl">
                <div class="shops-info layout_fl">
                    ...
                    <div class="shops-info-local">
                        <i class="page_icon in-shop-local-icon"></i>${hotel.hotel_tel}
                    </div>
                    <ul class="shops-info-list">
                        <li>联系电话：${hotelDetails.info_microphone}</li>
                        <li>公交线路：${hotelDetails.info_bus}</li>
                    </ul>
                </div>
        ...
        <div id="shops-section" class="content">
            ...
            <div class="shops-grids">
                ...
                <c:forEach var="hotelRoom" items="${hotelRoom}">
                                ...
                                <div class="shops-trans-teble">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="lab">形状</span><span>${hotelRoom.room_form}</span></td>
                                        </tr>
                                        <tr>
            ...
            <div class="shops-grids">
                ...
                <div class="shops-gdx-wrap">
                    <div class="shops-gdx-transdx">
                        <div class="shops-transdx-map"  id="dituContent">
                        </div>
                        <div class="shops-transdx-data">
                            <div class="shops-transdx-table">
                                <ul>
                                    <li style="width: 193.5px"><span class="lab">1星级</span><span >${hotelDetails.info_star_level}</span></li>
                                    <li style="width: 193.5px"><span class="lab">2装修时间</span><span >${hotelDetails.info_decorate_time}</span></li>
                                    <li style="width: 193.5px"><span class="lab">3订金</span><span >${hotelDetails.info_enter_fee}</span></li>
                                    <li style="width: 193.5px"><span class="lab">4服务费</span><span >${hotelDetails.info_service_fee}</span></li>
                                    <li style="width: 193.5px"><span class="lab">5进场费</span><span >${hotelDetails.info_service_fee}</span></li>
                                    <li style="width: 193.5px"><span class="lab">7婚房化妆间</span><span >${hotelDetails.info_dressing_room}</span></li>
                                    <li style="width: 388px"><span class="lab">6公交线路</span><span  style="width: 280px !important;">${hotelDetails.info_bus}</span></li>
                                    <li style="width: 193.5px"><span class="lab">8麦克风</span><span >${hotelDetails.info_microphone}</span></li>
                                    <li style="width: 193.5px"><span class="lab">9投影仪</span><span >${hotelDetails.info_projector}</span></li>
                                    <li style="width: 193.5px"><span class="lab">10桌布</span><span >${hotelDetails.info_tablecloth}</span></li>
                                    <li style="width: 193.5px"><span class="lab">11电费</span><span >${hotelDetails.info_electric_charge}</span></li>
                                    <li style="width: 193.5px"><span class="lab">12棋牌娱乐</span><span >${hotelDetails.info_amusement}</span></li>
                                </ul>
                            </div>
                            <div class="shops-transdx-text">
                                <div class="shops-transdx-inset">
                                    ${hotelDetails.info_subscription}
                                </div>
            ...
            <div class="shops-grids">
                ...
                <c:forEach var="hotelPackage" items="${hotelPackage}">
                <div class="shops-gdx-wrap">
                    <ul class="shops-gdx-list2 layout_clear fl_li" data-region="1">
                        <li>
                            <a href="/hotelPackage?package_id=${hotelPackage.package_id}&hotel_id=${hotelPackage.hotel_id}">
                            <div>
                                <div class="gdx-img">
                                    <img src="/images/${hotelPackage.package_img1}" style="width: 100%;" />
                                </div>
                                <div class="gdx-data">
                                    <div class="gdx-name">
                                        ${hotelPackage.package_name}
                                    </div>
                                    <div class="gdx-price">
                                        <span class="price-strong">￥${hotelPackage.package_price}</span>
                                        <!--<span class='price-text'>原价<span class='price-through'></span></span>-->
                                    </div>
                                    <div class="gdx-label">
                                        <p class="label-line"><span>产品摘要：</span>${hotelPackage.package_content}</p>
                                        <p class="label-line"><span>销量：</span>${hotelPackage.package_sales}</p>
                                    </div>
                                </div>
                            </div>
                            </a>
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(${hotelDetails.info_coordinatesA},${hotelDetails.info_coordinatesB});//定义一个中心点坐标
